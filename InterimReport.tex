...
programming language, called Pony, which will fix these problems.
...
physics and by the real world (compared to other models for concurrency, which
...
indeed has not) gained much popularity, with Mackay\cite{mackay97} claiming that
